...
namespace ProyectoProgramacionIIAPI.Migrations
{
    ...
    [Migration("20230614032458_AddUserTable")]
            ...
            modelBuilder.Entity("ProyectoProgramacionIIAPI.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = 1,
                            CategoryName = "Dolor",
                            DateOfCreation = new DateTime(2023, 6, 13, 21, 24, 58, 281, DateTimeKind.Local).AddTicks(869)
                        });
                });
            ...
            modelBuilder.Entity("ProyectoProgramacionIIAPI.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            CategoryId = 1,
                            DateOfCreation = new DateTime(2023, 6, 13, 21, 24, 58, 281, DateTimeKind.Local).AddTicks(776),
                            ProductCode = "121",
